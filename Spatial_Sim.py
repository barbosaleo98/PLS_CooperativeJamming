...
plt.scatter(x_planar_alices, y_planar_alices, marker='s', color='cyan' );
plt.scatter(x_planar_eves, y_planar_eves, marker='*', color='mediumorchid')
...
#xo_1 = -r
#xo_2 = r 
#plt.plot((xo_1, xo_2), (y0,y0), color='darkorchid', linewidth=1.5)
...
plt.scatter(x_vehicular_alices, y_vehicular_alices, color = 'lime', marker = '^');
plt.scatter(x_vehicular_eves, y_vehicular_eves, color='black', marker='o');
